...
#define SC8549_BAT_OVP_MAX			5075
...
#define SC8549_BAT_OCP_MAX			83000
...
#define	SC8549_VDROP_OVP_DIS_ENABLE		0
#define	SC8549_VDROP_OVP_DIS_DISABLE		1
...
#define	SC8549_VDROP_OVP_MASK_ENABLE		1
#define	SC8549_VDROP_OVP_MASK_DISABLE		0
...
#define SC8549_VBUS_OVP_DIS_ENABLE		1
#define SC8549_VBUS_OVP_DIS_DISABLE		0

#define SC8549_BUS_OVP_MASK			0x7F
#define SC8549_BUS_OVP_SHIFT			0
#define SC8549_BUS_OVP_BASE			6000
#define SC8549_BUS_OVP_MAX			12350
#define SC8549_BUS_OVP_LSB			50


/* Register 05h */
#define SC8549_REG_05				0x05
#define SC8549_IBUS_UCP_DIS_MASK		0x80
#define SC8549_IBUS_UCP_DIS_SHIFT		7
#define SC8549_IBUS_UCP_ENABLE			0
#define SC8549_IBUS_UCP_DISABLE			1

#define SC8549_IBUS_OCP_DIS_MASK		0x40
#define SC8549_IBUS_OCP_DIS_SHIFT		6
#define SC8549_IBUS_OCP_ENABLE			0
#define SC8549_IBUS_OCP_DISABLE			1

#define SC8549_IBUS_UCP_FALL_DG_SET_MASK	0x20
#define SC8549_IBUS_UCP_FALL_DG_SET_SHIFT	5
#define SC8549_IBUS_UCP_FALL_DG_SET_10US	0
#define SC8549_IBUS_UCP_FALL_DG_SET_5MS		1

#define SC8549_IBUS_OCP_MASK			0x0F
#define SC8549_IBUS_OCP_SHIFT			0
#define SC8549_IBUS_OCP_BASE			1200
#define SC8549_IBUS_OCP_MAX			5700
#define SC8549_IBUS_OCP_LSB			300
...
#define SC8549_CP_SWITCHING_STAT_MASK		0x04
#define SC8549_CP_SWITCHING_STAT_SHIFT		2
...
#define SC8549_SET_IBAT_SNS_RES_2M_OHM		1
#define SC8549_SET_IBAT_SNS_RES_5M_OHM		0
...
#define SC8549_POR_FLAG_MASK			0x40
#define SC8549_POR_FLAG_SHIFT			6
...
#define SC8549_WD_TIMEOUT_MASK			0x07
#define SC8549_WD_TIMEOUT_SHIFT			0
#define SC8549_WD_TIMEOUT_DISABLE		0
#define SC8549_WD_TIMEOUT_0P2S			1
#define SC8549_WD_TIMEOUT_0P5S			2
#define SC8549_WD_TIMEOUT_1S			3
#define SC8549_WD_TIMEOUT_5S			4
#define SC8549_WD_TIMEOUT_30S			5
...
#define SC8549_IBUS_REG_MAX			5700
...
#define SC8549_PMID2OUT_UVP_NEGATIVE_50MV	0
#define SC8549_PMID2OUT_UVP_NEGATIVE_100MV	1
#define SC8549_PMID2OUT_UVP_NEGATIVE_150MV	2
#define SC8549_PMID2OUT_UVP_NEGATIVE_200MV	3
...
#define SC8549_VOUT_OVP_FLT_STAT_MASK		0x80
#define SC8549_VOUT_OVP_FLT_STAT_SHIFT		7

#define SC8549_BAT_OVP_FLT_STAT_MASK		0x40
#define SC8549_BAT_OVP_FLT_STAT_SHIFT		6

#define SC8549_BAT_OCP_FLT_STAT_MASK		0x20
#define SC8549_BAT_OCP_FLT_STAT_SHIFT		5

#define SC8549_BUS_OVP_FLT_STAT_MASK		0x10
#define SC8549_BUS_OVP_FLT_STAT_SHIFT		4

#define SC8549_BUS_OCP_FLT_STAT_MASK		0x08
#define SC8549_BUS_OCP_FLT_STAT_SHIFT		3

#define SC8549_BUS_UCP_FALL_FLT_STAT_MASK	0x04
#define SC8549_BUS_UCP_FALL_FLT_STAT_SHIFT	2
...
#define SC8549_VOUT_OVP_FLT_FLAG_MASK		0x80
#define SC8549_VOUT_OVP_FLT_FLAG_SHIFT		7

#define SC8549_BAT_OVP_FLT_FLAG_MASK		0x40
#define SC8549_BAT_OVP_FLT_FLAG_SHIFT		6

#define SC8549_BAT_OCP_FLT_FLAG_MASK		0x20
#define SC8549_BAT_OCP_FLT_FLAG_SHIFT		5

#define SC8549_BUS_OVP_FLT_FLAG_MASK		0x10
#define SC8549_BUS_OVP_FLT_FLAG_SHIFT		4

#define SC8549_BUS_OCP_FLT_FLAG_MASK		0x08
#define SC8549_BUS_OCP_FLT_FLAG_SHIFT		3
...
#define SC8549_VOUT_OVP_FLT_MASK_MASK		0x80
#define SC8549_VOUT_OVP_FLT_MASK_SHIFT		7
#define SC8549_VOUT_OVP_FLT_MASK_ENABLE		1
#define SC8549_VOUT_OVP_FLT_MASK_DISABLE	0

#define SC8549_BAT_OVP_FLT_MASK_MASK		0x40
#define SC8549_BAT_OVP_FLT_MASK_SHIFT		6
#define SC8549_BAT_OVP_FLT_MASK_ENABLE		1
#define SC8549_BAT_OVP_FLT_MASK_DISABLE		0

#define SC8549_BAT_OCP_FLT_MASK_MASK		0x20
#define SC8549_BAT_OCP_FLT_MASK_SHIFT		5
#define SC8549_BAT_OCP_FLT_MASK_ENABLE		1
#define SC8549_BAT_OCP_FLT_MASK_DISABLE		0

#define SC8549_BUS_OVP_FLT_MASK_MASK		0x10
#define SC8549_BUS_OVP_FLT_MASK_SHIFT		4
#define SC8549_BUS_OVP_FLT_MASK_ENABLE		1
#define SC8549_BUS_OVP_FLT_MASK_DISABLE		0

#define SC8549_BUS_OCP_FLT_MASK_MASK		0x08
#define SC8549_BUS_OCP_FLT_MASK_SHIFT		3
#define SC8549_BUS_OCP_FLT_MASK_ENABLE		1
#define SC8549_BUS_OCP_FLT_MASK_DISABLE		0

#define SC8549_BUS_UCP_FALL_FLT_MASK_MASK	0x04
#define SC8549_BUS_UCP_FALL_FLT_MASK_SHIFT	2
#define SC8549_BUS_UCP_FALL_FLT_MASK_ENABLE	1
#define SC8549_BUS_UCP_FALL_FLT_MASK_DISABLE	0

#define SC8549_ADAPTER_INSERT_MASK_MASK		0x02
#define SC8549_ADAPTER_INSERT_MASK_SHIFT	1
#define SC8549_ADAPTER_INSERT_MASK_ENABLE	1
#define SC8549_ADAPTER_INSERT_MASK_DISABLE	0

#define SC8549_VBAT_INSERT_MASK_MASK		0x01
#define SC8549_VBAT_INSERT_MASK_SHIFT		0
#define SC8549_VBAT_INSERT_MASK_ENABLE		1
#define SC8549_VBAT_INSERT_MASK_DISABLE		0
...
#define SC8549_ADC_RATE_CONTINUOUS		0
#define SC8549_ADC_RATE_ONESHOT			1

#define SC8549_ADC_DONE_STAT_MASK		0x04
#define SC8549_ADC_DONE_STAT_SHIFT		2
#define SC8549_ADC_DONE_STAT_COMPLETE		1
#define SC8549_ADC_DONE_STAT_NOTCOMPLETE	0

#define SC8549_ADC_DONE_FLAG_MASK		0x02
#define SC8549_ADC_DONE_FLAG_SHIFT		1
#define SC8549_ADC_DONE_FLAG_COMPLETE		1
#define SC8549_ADC_DONE_FLAG_NOTCOMPLETE	0

#define SC8549_ADC_DONE_MASK_MASK		0x01
#define SC8549_ADC_DONE_MASK_SHIFT		0
#define SC8549_ADC_DONE_MASK_ENABLE		1
#define SC8549_ADC_DONE_MASK_DISABLE		0
...
#define SC8549_DP_SRC_10UA_ENABLE		1
#define SC8549_DP_SRC_10UA_DISABLE		0
...
#define SC8549_DM_BUF_MASK			0x30
#define SC8549_DM_BUF_SHIFT			4
#define SC8549_DM_BUF_600MV			0
#define SC8549_DM_BUF_2000MV			1
#define SC8549_DM_BUF_2700MV			2
#define SC8549_DM_BUF_3300MV			3

#define SC8549_DP_BUF_MASK			0x0C
#define SC8549_DP_BUF_SHIFT			2
#define SC8549_DP_BUF_600MV			0
#define SC8549_DP_BUF_2000MV			1
#define SC8549_DP_BUF_2700MV			2
#define SC8549_DP_BUF_3300MV			3

#define SC8549_DM_BUF_EN_MASK			0x02
#define SC8549_DM_BUF_EN_SHIFT			1
#define SC8549_DM_BUF_ENABLE			1
#define SC8549_DM_BUF_DISABLE			0

#define SC8549_DP_BUF_EN_MASK			0x02
#define SC8549_DP_BUF_EN_SHIFT			1
#define SC8549_DP_BUF_ENABLE			1
#define SC8549_DP_BUF_DISABLE			0


/* Register 23h */
#define SC8549_REG_23				0x23

#define SC8549_VDM_RD_MASK			0x38
#define SC8549_VDM_RD_SHIFT			3
#define SC8549_VDM_RD_LO_325MV			0
#define SC8549_VDM_RD_LO_1000MV			1
#define SC8549_VDM_RD_LO_1350MV			2
#define SC8549_VDM_RD_LO_2200MV			3
#define SC8549_VDM_RD_LO_3000MV			4
#define SC8549_VDM_RD_HI_3000MV			5


#define SC8549_VDP_RD_MASK			0x07
#define SC8549_VDP_RD_SHIFT			0
#define SC8549_VDP_RD_LO_325MV			0
#define SC8549_VDP_RD_LO_1000MV			1
#define SC8549_VDP_RD_LO_1350MV			2
#define SC8549_VDP_RD_LO_2200MV			3
#define SC8549_VDP_RD_LO_3000MV			4
#define SC8549_VDP_RD_HI_3000MV			5
...
#define SC8549_DM_LOW_NOT_MASK			0
#define SC8549_DM_LOW_MASK			1
...
#define SC8549_DP_LOW_NOT_MASK			0
#define SC8549_DP_LOW_MASK			1
...
#define SC8549_DPDM_OVP_NOT_MASK		0
#define SC8549_DPDM_OVP_MASK			1
...
#define SC8549_DEV_ID_MASK			0xFF
#define SC8549_DEV_ID_SHIFT			0
#define SC8549_DEV_ID				0x66
